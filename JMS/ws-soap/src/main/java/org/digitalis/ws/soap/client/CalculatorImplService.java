 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://server.soap.ws.digitalis.org/", wsdlLocation = "http://127.0.0.1:10000/calcServer?wsdl")
public class CalculatorImplService extends Service {
	...
	private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://server.soap.ws.digitalis.org/",
	...
	/**
	 * 
	 * @return returns CalculatorI
	 */
	@WebEndpoint(name = "CalculatorImplPort")
	public CalculatorI getCalculatorImplPort() {
		return super.getPort(new QName("http://server.soap.ws.digitalis.org/", "CalculatorImplPort"),
				CalculatorI.class);
	}
	...
	public CalculatorI getCalculatorImplPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://server.soap.ws.digitalis.org/", "CalculatorImplPort"), CalculatorI.class,
				features);
	}
