...
public class TesteGmail {
	...
	private static final String EMAIL = "anderson.lopes.2010@gmail.com";
	...
	public static void main(String[] args) throws AddressException, MessagingException {
		...
		email.setRecipient(Message.RecipientType.TO, new InternetAddress("anderson.lopes.2010@gmail.com"));
